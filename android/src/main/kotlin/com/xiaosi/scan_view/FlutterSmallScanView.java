...
public class FlutterSmallScanView implements PlatformView, MethodCallHandler  {
    private final DecoratedBarcodeView scanView;
    private final MethodChannel methodChannel;

    FlutterSmallScanView(Context context, BinaryMessenger messenger, int id){
...
//        scanView = new DecoratedBarcodeView(context);
        ...
        v.add(BarcodeFormat.UPC_A);
        v.add(BarcodeFormat.UPC_E);
        v.add(BarcodeFormat.EAN_13);
        v.add(BarcodeFormat.EAN_8);
        v.add(BarcodeFormat.RSS_14);
        ...
        methodChannel = new MethodChannel(messenger, "plugins.xiaosi.smallscanview_" + id);
